            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <select 
                        ...
                        <option 
                            value="pending" 
                            @if(old('status', $reservation->status) === 'pending') selected @endif>
                            ⏳ Pending
                        </option>
                        <option 
                            value="confirmed" 
                            @if(old('status', $reservation->status) === 'confirmed') selected @endif>
                            ✓ Terkonfirmasi
                        </option>
                        <option 
                            value="cancelled" 
                            @if(old('status', $reservation->status) === 'cancelled') selected @endif>
                            ✗ Dibatalkan
                        </option>
                    </select>
                    @error('status')
